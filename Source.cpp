...
int main()
{
    ...
    {
        std::system("cls");
        cout << "1. BUSCAR REGISTRO PAIS POR CODIGO" << endl;
        ...
        cout << "6. FUNCION GENERICA PAIS" << endl;
        cout << "7. FUNCION GENERICAE CIUDAD" << endl;
        cout << "8. FILE MANAGE PAIS" << endl;
        cout << "9. FILE MANAGE CIUDADES" << endl;
        cout << "0. SALIR" << endl;
        cout << "*********************************************" << endl;
        cout << "Opcion: ";
        cin >> opcion;
        ...
        case 8:
        {
            ...
            fileManage.ReadFile(paises, "paises.dat");
			break;
        }
		...
		case 9:
		{
			...
			fileManage.ReadFile(ciudades, "ciudades.dat");
		}
            break;
        case 0:
            cout << "Saliendo..." << endl;
